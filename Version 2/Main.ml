...
let%test _ = ( getValeur (main "../../exemples/exemple-13.mml") = (IntegerValue 2) )
let%test _ = ( getValeur (main "../../exemples/exemple-14.mml") = (IntegerValue 1) )
(*let%test _ = ( getValeur (main "../../exemples/exemple-15.mml") = (IntegerValue 5) )*)
(*
let%test _ = (main "../../exemples/exemple-00.mml") = (IntegerType, IntegerValue 1, []) 
*)
...
(*let%test _ = ( getType (main "../../exemples/exemple-09.mml") = (FunctionType(UnknownType,UnknownType)))*)
let%test _ = ( getType (main "../../exemples/exemple-11.mml") = (ErrorType))
let%test _ = ( getType (main "../../exemples/exemple-12.mml") = (IntegerType))
let%test _ = ( getType (main "../../exemples/exemple-13.mml") = (IntegerType))
