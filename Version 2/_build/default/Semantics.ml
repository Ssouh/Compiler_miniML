...
ruleWrite refexpr valexpr mem env =
  let (v,m3) = value_of_expr (valexpr,mem) env in
      let (vrefexpr,mrefexpr) = value_of_expr (refexpr,m3) env in
    match vrefexpr with
      ...
      | ReferenceValue reference ->
        (match (lookforMem reference mrefexpr) with
          ...
          | Found value -> (NullValue,((reference,v)::mrefexpr)))
...
ruleWhile cond body mem env = ((ErrorValue UndefinedExpressionError),mem)
(* ...............A COMPLETER .......................................*)
